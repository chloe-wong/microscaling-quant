...
mxq/microxcaling/elemwise.py). This is the element step of the OCP reference block algorithm, with the flags
...
Reference only; block.ocp is its one caller. FP32 (pass-through) has no OCP element format and is rejected.
"""
