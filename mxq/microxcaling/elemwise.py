...
Verbatim from microsoft/microxcaling mx/elemwise_ops.py @ 7bc4195
Functions copied unchanged: _safe_lshift, _safe_rshift, _round_mantissa, _quantize_elemwise_core, _quantize_elemwise, _quantize_bfloat
Only this header and the import lines differ from upstream. See UPSTREAM.md.
"""
import torch
